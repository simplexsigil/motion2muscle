...
def get_args_parser(parse=True):
    ...
    parser.add_argument("--eval-batch-size", default=128, type=int, help="batch size")
    parser.add_argument("--window-size", type=int, default=64, help="training motion length")
    parser.add_argument("--vq_enc_emb_width", default=None, type=int, help="input feature dimension of vqae decoder")
    parser.add_argument("--vq_dec_emb_width", default=402, type=int, help="output feature dimension of vqae decoder")
