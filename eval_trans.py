...
import models.m2m_transformer as m2m_transformer
import models.m2m_convs2s as m2m_convs2s
import models.m2m_lstm as m2m_lstm
import models.m2m_mamba as m2m_mamba
    ...
    for batch in val_loader:
        ...
        for i in range(bs):
            ...
            metadata.append(
                {
                    "name": name[i],
                    "gt_name": name[i].replace("/", "__I__") + "_" + str(i) + "_gt.npy",
                    "pred_name": name[i].replace("/", "__I__") + "_" + str(i) + "_pred.npy",
...
# model = ["trans", "fconv", "mamba2", "lstm"]

if args.model == "trans":
    net = m2m_transformer.MotionToMuscleModel(
        input_width,
        output_width,
        args.width,
    ...
    net = m2m_convs2s.FConvMotionToMuscleModel(
        input_width,
        output_width,
        args.width,
        num_layers=args.num_layers,
    ...
    net = m2m_mamba.MixerModel(d_input=input_width, d_output=output_width)
elif args.model == "lstm":
    net = m2m_lstm.LSTMMotionToMuscleModel(
        input_width,
        output_width,
        args.width,
        num_layers=args.num_layers,
